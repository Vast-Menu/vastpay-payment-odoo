...
class PosOrder(models.Model):
    ...
    def _process_order(self, *args, **kwargs):
        ...
        Signature is left version-agnostic (``*args``) on purpose: the core
        ``_process_order`` arguments differ across Odoo majors. We only
        rely on its documented return value (the created/updated order id).
